...
<html lang="en">
<head>
	<title>BodyWorks | About Us Page</title>
	<meta charset="UTF-8">
...
<body>
	...
	<nav class="navbar navbar-expand d-flex flex-column align-item-start" id="sidebar">
		...
		<ul class="navbar-nav d-flex flex-column mt-5 w-100">
			...
			<li class="nav-item w-100">
				<a href="aboutUs.php" class="nav-link text-light pl-4 active">About Us</a>
			</li>
			<li class="nav-item w-100">
			...
			<li class="nav-item w-100">
				<a href="contactUs.php" class="nav-link text-light pl-4">Contact Us</a>
			</li>
			<hr>
			<li class="nav-item w-100">
